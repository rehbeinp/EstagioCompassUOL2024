...
#### Execução:
&nbsp;&nbsp;&nbsp; Ocorreu então o build da imagem  e a  criação do volume ([comandos](https://github.com/rehbeinp/EstagioC_UOL/blob/main/Sprint06/3.Evid%C3%AAncias/Desafio/1comandos_docker.txt)): <p>
<img src=..\Sprint06\3.Evidências\Desafio\imagem1.png width=500><p>
&nbsp;&nbsp;&nbsp; Após isso executei um container no modo interativo e com o terminal bash ([comando](https://github.com/rehbeinp/EstagioC_UOL/blob/main/Sprint06/3.Evid%C3%AAncias/Desafio/1comandos_docker.txt)), isso com o volume referênciado: <p>
...
&nbsp;&nbsp;&nbsp; Exectando o código python pelo terminal do container, criando o bucket e fazendo upload de objeto ([nome dos objetos](https://github.com/rehbeinp/EstagioC_UOL/blob/main/Sprint06/3.Evid%C3%AAncias/Desafio/1nome_objeto.txt)): <p>
