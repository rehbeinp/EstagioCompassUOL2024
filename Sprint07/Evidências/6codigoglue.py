...
maior_fem=dataframe.groupBy("ano","sexo","nome").agg(max("total")).where(Func.col("sexo")=='F').limit(1)

# Converte o DataFrame para DynamicFrame
dynamic_frame = DynamicFrame.fromDF(maior_fem, glueContext, "dynamic_frame")
