...
total_nomes_ano=dataframe.groupBy("ano","sexo").agg(count("nome").alias("contagem_nome_por_ano")).orderBy(Func.col("ano").desc())

# Converte o DataFrame para DynamicFrame
dynamic_frame = DynamicFrame.fromDF(total_nomes_ano, glueContext, "dynamic_frame")
